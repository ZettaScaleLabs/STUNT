...
from stunt.types import Location, Transform, Rotation, Vector3D
...
class Lane(object):
    ...
    def collect_frame_data(
        self, frame, binary_frame, camera_setup, inverse_transform=None
    ):
    ...
    def to_dict(self):
        return {
            "id": self.id,
            "left_markings": self.left_markings,
            "right_markings": self.right_markings,
        }
